...
ONLY CHANGE F2016A7PS0036P to Your ID
*/
object Driver{
  ...
  def main(args:Array[String]){
    ...
    //Dot product
    val res1=F2016A7PS0036P.dotProduct(kernel1,kernel2)

    // println(prod)
    //convolution 
    val res2=F2016A7PS0036P.convolute(image,kernel1,imagesize,kernel1size) 

    // println(result)

    //activation 
    val res3=F2016A7PS0036P.activationLayer((x:Double)=>if(x>150) x else 0,image) 

    // println(result)

    //single pooling

    val res4=F2016A7PS0036P.singlePooling(max,poolmat,size)
    //pooling

    val res5=F2016A7PS0036P.poolingLayer(max,image,size) // max is a function

    //Normalize

    val res6=F2016A7PS0036P.normalise(nmat) 

    //mixed layer

    val res7=F2016A7PS0036P.mixedLayer(image,kernel1,imagesize,kernel1size,(x:Double)=>x,max,size) // max is a function
...
val res8=time{F2016A7PS0036P.assembly(image,imagesize,w1,w2,b,kernel1,kernel1size,kernel2,kernel2size,kernel3,kernel3size,size)}
    // val res8=F2016A7PS0036P.assembly(image,imagesize,w1,w2,b,kernel1,kernel1size,kernel2,kernel2size,kernel3,kernel3size,size)
